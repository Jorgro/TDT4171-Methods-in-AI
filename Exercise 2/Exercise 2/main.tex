...
\begin{punkt}
    ...
    So even though we had evidence of no birds nearby on two of the days, the most likely sequence is that all days had fish nearby.
    This happens because the Viterbi algorithm takes into account the join probabilities over all the time steps.
\end{punkt}
